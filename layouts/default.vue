<template>
  <div>
    <!-- Nav Starts -->
    <navbar />
    <p class="text-gray-800 dark:text-gray-200 fixed top-4 md:top-6 left-6 block lg:hidden z-40" @click="showSideNav()">
    ...
    <!-- Nav Ends -->
    <!-- Main App starts -->
    <div class="transition ease-in-out duration-500 dark:bg-gray-900 bg-gray-100 min-h-screen">
      <div
