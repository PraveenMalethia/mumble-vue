<template>
  <div
    class="flex mb-3 overflow-clip w-full pr-28 break-all"
  ...
  >
    ...
    />
    <div
      class="p-2 rounded max-w-full flex break-words dark:text-gray-300"
      :class="{
        'break-words bg-blue-400 dark:bg-purple-800 dark:text-gray-300':
          'true' == author,
