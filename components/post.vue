<template>
    ...
    >
      ...
      <section v-if="options" class="h-screen w-screen absolute top-0 -left-6"></section>
      ...
      <div class="flex items-center px-4 py-2">
        <div class="flex flex-col">
          ...
          <span
            class="pl-1.5 dark:text-gray-200 mr-1 flex items-center justify-center"
          >
            ...
            <span v-else>
              ...
              {{ mumble.original_mumble ? mumble.original_mumble.vote_rank : mumble.vote_rank}}
            </span>
          <button
